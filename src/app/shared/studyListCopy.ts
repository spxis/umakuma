...
export const STUDY_LIST_COPY = {
  ...
  mapsEmpty: "No custom maps yet. In the Map game, choose Create custom set… in the Play row and tap the prefectures you are learning.",
  mapsOpen: "View / edit",
  mapsDelete: "Delete",
  ...
  mapsViewLabel: "View",
  mapsViewList: "List",
  mapsViewShapes: "Shapes",
  mapsSiteHeading: "Public maps",
  ...
  mapsSiteBadge: "Public map",
  mapsBy: (name: string) => `by ${name}`,
  mapsView: "View",
  mapsShare: "Make public",
