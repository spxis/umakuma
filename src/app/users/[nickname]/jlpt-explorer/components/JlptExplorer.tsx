...
import { useJlptFilterState } from "../lib/useJlptFilterState";
...
export default function JlptExplorer({
  ...
  /* The filters, remembered per browser and said in the address. */
  const filters = useJlptFilterState(accountId);
  const {
