...
export const STUDY_PANEL_TEXT = {
  ...
  changeStudyLibrary: "Change study library",
  chooseStudyLibrary: "Choose study library",
  tapTitleToChangeLibrary: "Tap title to change library",
  tapTitleToChooseLibrary: "Tap title to choose library",
  change: "Change",
  filters: "Filters",
  searchScope: "study",
  ...
  groupingFilters: "Grouping filters",
  compactLevel: "Compact level",
  expandLevel: "Expand level",
  expandLevelFilters: "Expand level filters",
  resetFilters: "Reset filters",
  clearAll: "Clear all",
  tagFilterTroubleOnly: "Trouble only",
  tagFilterFavouritesOnly: "Favourites only",
  tagFilterClearHint: "Showing tagged items only. Select to show the whole queue.",
  all: "All",
  oldestWaitShort: "Old",
  oldestWait: "Oldest",
  newestWaitShort: "New",
  ...
  bulkShort: "Bulk",
  font: "Font",
  loadingQueueAndFilters: "Loading study queue and filters...",
...
export const STUDY_REVIEW_MODAL_SECTION_TEXT = {
  ...
  troublePractice: "Trouble practice",
  troublePracticeHint: "Reminder only. This will not submit a WaniKani review.",
