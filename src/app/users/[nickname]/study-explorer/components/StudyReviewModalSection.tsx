...
import { isLessonLockedQueueItem, isLessonQueueItem, isRadicalSubjectType, STUDY_REVIEW_OUTCOMES, STUDY_REVIEW_MODAL_SECTION_TEXT, STUDY_VIEWER_MODES } from "./StudyExplorer.constants";
...
import { ReadingWithPronunciation, glyphTextSizeClass, jlptLevelPillClass, shortSubjectTypeLabel, stripHtml, subjectTypePillClass, typeGlyphBoxClass } from "../../level-explorer/lib/levelExplorerDisplay";
        ...
        {!studyMode && viewerMode === STUDY_VIEWER_MODES.flash ? (
          ...
          <>
            <div className="grid h-full min-h-0 flex-1 grid-rows-[35%_65%] gap-1.5 lg:grid-cols-2 lg:grid-rows-1 lg:gap-2 lg:items-stretch">
              ...
              >
                <GlyphLevelLabel level={selectedItem.wkLevel} className="right-3 top-3 sm:right-4 sm:top-4" />
          ...
          shouldUseUnifiedLessonDetail ? (
            ...
            <div>
              ...
              <div className={`relative inline-flex min-h-[5.75rem] min-w-[5.75rem] items-center justify-center rounded-2xl border px-4 py-3 ${typeGlyphBoxClass(selectedItem.subjectType)}`}>
