    ...
    >
      ...
      {isMenuOpen ? (
        <div
          ...
          onMouseLeave={closeHoverMenuSoon}
        >
          <span aria-hidden="true" className="pointer-events-none absolute -top-[11px] left-[calc(25%-0.625rem)] h-0 w-0 border-x-[10px] border-b-[10px] border-x-transparent border-b-line">
