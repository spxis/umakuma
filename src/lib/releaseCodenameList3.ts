...
export const CODENAMES_PART_3: readonly ReleaseCodename[] = [
  ...
  { romaji: "Makoto no Mochimae", ja: "真の持ち前", reading: "まことのもちまえ", gloss: "the standing that is genuinely yours" },
  ...
  { romaji: "Raireki", ja: "来歴", reading: "らいれき", gloss: "where a thing has been, written down" },
  ...
  { romaji: "Uketsugi no Mitame", ja: "受け継ぎの見た目", reading: "うけつぎのみため", gloss: "the look, carried over" },
  ...
  { romaji: "Seijitsu", ja: "誠実", reading: "せいじつ", gloss: "honesty" },
  ...
  { romaji: "Utage", ja: "宴", reading: "うたげ", gloss: "a banquet: the site's lists laid out for every member" },
  ...
  { romaji: "Shiharai", ja: "支払い", reading: "しはらい", gloss: "Payment - what each award paid, written down even when it paid nothing" },
  { romaji: "Sukima", ja: "隙間", reading: "すきま", gloss: "a gap: the room between a tap and a loss" },
];
